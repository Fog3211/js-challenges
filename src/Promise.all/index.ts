declare global {
  interface PromiseConstructor {
    myAll<T extends readonly unknown[] | []>(values: T): Promise<{ -readonly [P in keyof T]: Awaited<T[P]> }>
  }
}

export function initPromiseAll() {
  Promise.myAll = function<T extends readonly unknown[] | []>(_promises: T) {
    if (!(typeof _promises === 'object' && _promises !== null && typeof _promises[Symbol.iterator] === 'function')) {
